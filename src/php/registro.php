...
<body>
    ...
    if (isset($_POST['registro'])) {
        ...
        if ($fila['cuenta'] == 0) {
            ...
            $consulta = "insert into users values('$mail','$fullname','$user','$password')";
            $resul = ConsultaSimple($consulta);
            echo '<script>alert("Cuenta creada exitosamente");</script>';
        } else {
            echo '<script>alert("Este correo ya tiene una cuenta asociada");</script>';
        }
    }
    ?>
    <div>
                ...
                <main class="form-signin w-100 m-auto">
                    <form name="fRegistro" action='<?php echo $_SERVER['PHP_SELF']; ?>' method="post">
                        <fieldset>
                            ...
                            <h3 class="h3 mb-3 fw-normal">Registration</h3>
                            ...
                            <input type="submit" value="Registrarse" name="registro" class="btn btn-primary w-100 py-2">
                            <p><a href="index.php" class="link-primary">Volver al inicio</a></p>
